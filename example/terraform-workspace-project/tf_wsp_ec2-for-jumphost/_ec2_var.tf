...
variable "ami_id" {
  description = "The ID of the Operating System (OS) AMI"
  type        = string
  default     = "ami-0d21214905506a7f4" # Ubuntu 22.04 64bit-x86
  # default   = "ami-06b79cf2aee0d5c92" # Amazon Linux 2 64bit-x86
  # default   = "ami-0c91f4476780c2eaf" # Amazon Linux 2023 64bit-x86
}
