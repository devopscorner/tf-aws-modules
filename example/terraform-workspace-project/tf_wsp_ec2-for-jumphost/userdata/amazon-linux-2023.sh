...
# ================================================================================================
#  INSTALL USER-DATA (AMAZON LINUX 2023)
# ================================================================================================
...
export TERRAGRUNT_VERSION=0.48.3
...
wget -O $HOME/.tmux.conf https://github.com/devopscorner/scripts/blob/main/installer/config/.tmux.conf
wget -O $HOME/tmuxcolors.tmux https://github.com/devopscorner/scripts/blob/main/installer/config/tmuxcolors.tmux
...
wget -O $HOME/.p10k.zsh https://github.com/devopscorner/scripts/blob/main/installer/config/.p10k.zsh
