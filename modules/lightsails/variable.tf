...
# --------------------------------------------------------------------------
variable "aws_region" {
  description = "The AWS region to deploy the Lightsail instance in"
  type        = string
}

variable "aws_account_id" {
  description = "The AWS Account ID to deploy the Lightsail instance in"
  type        = string
}

variable "aws_account_profile" {
  description = "The AWS Profile to deploy the Lightsail instance in"
  type        = string
}
...
variable "tfstate_path" {
  ...
  type        = string
  default     = "lightsails/terraform.tfstate"
}
