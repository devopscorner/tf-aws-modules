...
# --------------------------------------------------------------------------
variable "aws_region" {
  description = "The AWS region to deploy the Route53 record"
  type        = string
}

variable "aws_account_id" {
  description = "The AWS Account ID to deploy the Route53 record"
  type        = string
}

variable "aws_account_profile" {
  description = "The AWS Profile to deploy the Route53 record"
  type        = string
}
...
variable "tfstate_path" {
  ...
  type        = string
  default     = "route53/terraform.tfstate"
}
